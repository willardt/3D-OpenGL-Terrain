...
void Terrain::load_textures() {
	_tile_texture.id = SOIL_load_OGL_texture("Data\\tile.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0);
...
void Tile_Selection::update_selection_vao() {
